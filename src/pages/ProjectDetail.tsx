  ...
  if (!project) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center pt-20">
        <h2 className="text-2xl font-bold text-gov-blue-900 mb-4">Projeto nao encontrado</h2>
        <Link to="/" className="text-gov-blue-700 hover:underline">Voltar para a pagina inicial</Link>
      </div>
    );
  }
