    ...
    <footer className="relative overflow-hidden py-12 md:py-16 border-t-0 bg-[#2A2368] text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
        ...
        <div className="flex gap-8">
          ...
          <a href="#" className="text-[0.625rem] font-black uppercase tracking-widest text-white hover:text-[#FBF137] transition-colors">Privacidade</a>
          <a href="#" className="text-[0.625rem] font-black uppercase tracking-widest text-white hover:text-[#FBF137] transition-colors">Contratos</a>
        </div>
      </div>
    </footer>
  );
