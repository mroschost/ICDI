  ...
  return (
    <section className="px-6 py-8 md:py-12">
      <div className="max-w-7xl mx-auto bg-gov-blue-700 p-8 md:p-20 rounded-3xl text-center text-white relative overflow-hidden shadow-2xl">
        ...
        <p className="text-base md:text-lg text-gov-blue-50 max-w-2xl mx-auto mb-8 md:mb-10 opacity-80">Continuamos trabalhando para expandir nossas frentes de atuação e levar dignidade a mais pessoas no Distrito Federal.</p>
        <Link
          to="/#projects"
