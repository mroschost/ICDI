        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-8 mb-8 md:mb-12">
          <div className="max-w-xl">
            <h2 className="text-xl md:text-2xl font-bold text-gov-blue-900 mb-4 md:mb-6 flex items-center gap-3">
              <span className="w-8 h-px bg-gov-yellow"></span> Transparência e Documentação
            </h2>
            <p className="text-sm md:text-base text-slate-600">
              Acesso aos documentos e registros oficiais que comprovam a execução técnica e social deste projeto.
            </p>
          </div>
          <Link
            to="/transparencia"
