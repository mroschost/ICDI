...
export const PROJECTS: Project[] = [
  {
    ...
    transparency: [],
    objectives: [
      'Valorizar as tradicoes juninas e a cultura popular do Distrito Federal',
      'Promover convivencia comunitaria em espaco educativo e cultural',
      'Ampliar o acesso do publico a programacao artistica gratuita'
    ],
    results: [
      'Evento inserido no portfolio institucional de 2026',
      'Programacao cultural em espaco de referencia educativa',
      'Fortalecimento da presenca territorial do ICDI'
    ],
    iconName: 'Music',
    color: 'bg-amber-500'
  },
  ...
  },
  {
    ...
    objectives: [
      ...
      'Levar programacao cultural gratuita para diferentes territorios'
    ],
    results: [
      'Circuito realizado em 5 cidades do Distrito Federal',
      'Participacao de 35 artistas e mais de 75 microempreendedores',
      'Milhares de pessoas alcancadas pelo evento'
    ],
    iconName: 'Music',
    color: 'bg-orange-500'
  },
  {
    ...
    objectives: [
      ...
      'Ampliar o acesso da populacao a servicos de empregabilidade',
      'Articular empresas e poder publico em uma grande acao de oportunidades'
    ],
    results: [
