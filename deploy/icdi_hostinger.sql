...
VALUES
  (
    ...
    'O Arraiï¿½ do Cerrado foi realizado na Escola Parque da Natureza e Esporte como uma ao cultural voltada a valorizao das tradições populares e ao fortalecimento do convvio comunitrio. A iniciativa integra o calendrio de eventos do ICDI com foco em acesso a cultura, ocupao qualificada de espaï¿½os pï¿½blicos e experincias coletivas para crianas, jovens e famlias do Distrito Federal.',
    ...
    '[]',
    '["Valorizar as tradições juninas e a cultura popular do Distrito Federal","Promover convivï¿½ncia comunitria em espaço educativo e cultural","Ampliar o acesso do pï¿½blico a programaï¿½ï¿½o artstica gratuita"]',
  ...
  (
    ...
    'Um projeto cultural realizado em Ceilndia voltado a valorizao das tradições juninas e da cultura popular do Distrito Federal.',
    'Um projeto cultural realizado em Ceilndia voltado a valorizao das tradições juninas e da cultura popular do Distrito Federal. A iniciativa reuniu grupos de quadrilha, artistas locais e a comunidade em uma programaï¿½ï¿½o festiva que fortaleceu a identidade cultural, incentivou a participao popular e promoveu o acesso as manifestaes tradicionais brasileiras.',
    '/eventos_v2/fotos/foto_01_pagina_06.jpg',
    '["/eventos_v2/fotos/foto_01_pagina_06.jpg","/eventos_v2/fotos/foto_02_pagina_06.jpg"]',
    '[]',
    '["Valorizar as tradições juninas do Distrito Federal","Incentivar a participao comunitria","Promover artistas e grupos culturais locais","Preservar manifestaes populares brasileiras"]',
  ...
  (
    ...
    '["Celebrar a histria da cidade","Valorizar identidade cultural local","Oferecer programaï¿½ï¿½o gratuita a população","Fortalecer espaï¿½os pï¿½blicos por meio da cultura"]',
  ...
  (
    ...
    '["Valorizar a cultura popular e as tradições juninas em cinco cidades do DF","Fortalecer a economia local com microempreendedores e artistas","Levar programaï¿½ï¿½o cultural gratuita para diferentes territorios"]',
  ...
  (
    ...
    '["Conectar trabalhadores a vagas de emprego e processos seletivos","Ampliar o acesso da população a servios de empregabilidade","Articular empresas e poder pï¿½blico em uma grande ao de oportunidades"]',
